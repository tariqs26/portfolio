...
export const Light = (props: ClrSchemeIconProps) => {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export const Dark = (props: ClrSchemeIconProps) => {
  return (
    <svg
      {...props}
      className="nav-clr-scheme"
